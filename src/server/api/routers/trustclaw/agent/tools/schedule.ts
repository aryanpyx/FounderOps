...
export function createScheduleTool(
  ...
  return {
    description:
      "Manage recurring background automations for THIS assistant only (cron jobs that re-run this assistant at set times, e.g. a daily morning brief). NOT for Google Calendar events, Google Tasks, or to-do items - use the Google Calendar / Google Tasks tools for those.",
