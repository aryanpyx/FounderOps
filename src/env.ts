...
export const env = createEnv({
  server: {
    ...
    // small enough for the Groq free-tier TPM limit. Connections stay intact.
    COMPOSIO_TOOLKITS: z.string().optional(),
    ...
    // Optional NVIDIA NIM key (build.nvidia.com - free, no card). Gives llama-3.3-70b
    // with a full 128k context (no Groq 12k TPM wall, so all tools fit). Preferred
